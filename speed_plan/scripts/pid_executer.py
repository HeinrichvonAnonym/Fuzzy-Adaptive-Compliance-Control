...
control_input_name = config["control_input_name"]
control_interface_class = config["control_interface_class"]
if control_input_name == "in/joint_velocity":
...
class PIDExecuter:
    def __init__(self):
        ...
        self.joint_velocity_pub = rospy.Publisher(control_input_name, eval(control_interface_class), queue_size=10)
